...
const adminItems = [
  { title: "Admin Overview", url: "/admin", icon: ShieldAlert },
  { title: "Manage Users", url: "/admin/users", icon: Users },
  { title: "System Inventory", url: "/admin/inventory", icon: Package },
  ...
  return (
    <Sidebar collapsible="icon">
      ...
      <SidebarContent>
        ...
        {(userRole === 'customer' || isOnCustomerPage) && (
          <SidebarGroup>
            <SidebarGroupLabel className="text-sidebar-foreground/50 text-[11px] uppercase tracking-wider">
              Customer
            </SidebarGroupLabel>
